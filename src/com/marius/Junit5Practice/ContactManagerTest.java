package com.marius.Junit5Practice;
...
class ContactManagerTest {
    ...
    public void shouldCreateContact() {
        ...
        contactManager.addContact("Marius", "Dragos", "0123456789");
    ...
    public void shouldThrowRuntimeExceptionWhenFirstNameIsNull() {
        Assertions.assertThrows(RuntimeException.class, () -> {
            contactManager.addContact(null, "Dragos", "0123456789");
        });
    }
    ...
    public void shouldThrowRuntimeExceptionWhenLastNameIsNull() {
        Assertions.assertThrows(RuntimeException.class, () -> {
            contactManager.addContact("Marius", null, "0123456789");
        });
    }
    ...
    public void shouldThrowRuntimeExceptionWhenPhoneNumberIsNull() {
        Assertions.assertThrows(RuntimeException.class, () -> {
            contactManager.addContact("Marius", "Dragos", null);
        });
    }
